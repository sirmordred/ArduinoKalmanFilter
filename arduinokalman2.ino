/*
 * Multi filter which fuses accel,gyro,magnetic datas to smooth altitude and climbrate(which come from pressure sensor)
 * Include two filter: 1-Kalman filter 2-Madgwick quaternion filter
 *
 * Copyright (C) 2016 Oguzhan Yigit,Osman Yigit
 *
